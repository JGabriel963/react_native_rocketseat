  ...
  return (
    <button className="outline-none rounded-md text-left bg-slate-800 p-5 space-y-3 relative overflow-hidden hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
      ...
      <p className="text-sm leading-6 text-slate-400">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Id ea cum at
        odit earum. Nobis similique sint natus perspiciatis, illo reiciendis
        obcaecati saepe, asperiores, libero error eius ab. Officia, saepe.
      </p>
