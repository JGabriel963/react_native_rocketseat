  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button className="outline-none rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 relative overflow-hidden hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
